...
Route::get('/customer/my-vouchers', [\App\Http\Controllers\CustomerVoucherController::class, 'myVouchers'])->name('customer.my_vouchers');
Route::post('/customer/vouchers/save', [\App\Http\Controllers\CustomerVoucherController::class, 'saveVoucher'])->name('vouchers.save');
