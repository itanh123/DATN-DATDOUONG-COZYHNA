...
@if(session()->has('user_id'))
    ...
    <a href="/customer/account?tab=vouchers" class="relative flex items-center justify-center text-primary p-2 hover:bg-surface-container-low rounded-full transition-colors active:scale-95" title="Mã giảm giá của tôi">
    ...
    <div class="relative group">
        ...
        @else
            <a href="/customer/account" class="material-symbols-outlined text-primary p-2 hover:bg-surface-container-low rounded-full transition-colors active:scale-95 flex items-center" data-icon="account_circle" title="Tài khoản">account_circle</a>
        @endif

        <!-- Dropdown Menu -->
        <div class="absolute right-0 top-full mt-2 w-48 bg-white rounded-xl shadow-lg border border-outline-variant/30 py-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
            <a href="/customer/account" class="block px-4 py-2 text-body-sm text-on-surface hover:bg-surface-container-low transition-colors">
                <span class="material-symbols-outlined align-middle mr-2 text-[20px]">person</span>Hồ sơ
            </a>
            <a href="/customer/account?tab=vouchers" class="block px-4 py-2 text-body-sm text-on-surface hover:bg-surface-container-low transition-colors">
                <span class="material-symbols-outlined align-middle mr-2 text-[20px]">local_activity</span>Mã giảm giá
            </a>
        </div>
    </div>
