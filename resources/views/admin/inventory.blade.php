...
<button class="px-xl py-md bg-tertiary text-on-tertiary rounded-xl font-label-md hover:brightness-110 transition-all">{{ __('Review Items') }}</button>
</div>
<!-- Action Buttons -->
...
<span class="material-symbols-outlined text-primary">Kho</span>
</div>
...
<div class="bg-surface-container-lowest p-lg rounded-xl border border-outline-variant shadow-sm hover:shadow-md transition-shadow">
<div class="flex items-center justify-between mb-sm">
<span class="font-label-sm text-on-surface-variant uppercase tracking-wider">{{ __('Low Stock Items') }}</span>
...
<div class="mt-xs">
<span class="px-2 py-0.5 bg-tertiary-container/20 text-tertiary rounded-full font-label-sm">{{ __('Needs Ordering') }}</span>
</div>
</div>
<div class="bg-surface-container-lowest p-lg rounded-xl border border-outline-variant shadow-sm hover:shadow-md transition-shadow">
<div class="flex items-center justify-between mb-sm">
<span class="font-label-sm text-on-surface-variant uppercase tracking-wider">{{ __('Out of Stock') }}</span>
<span class="material-symbols-outlined text-error">cancel</span>
</div>
<div class="font-headline-lg text-headline-lg text-error">03</div>
<div class="mt-xs">
<span class="px-2 py-0.5 bg-error-container/20 text-error rounded-full font-label-sm">{{ __('High Priority') }}</span>
</div>
</div>
<div class="bg-surface-container-lowest p-lg rounded-xl border border-outline-variant shadow-sm hover:shadow-md transition-shadow">
<div class="flex items-center justify-between mb-sm">
<span class="font-label-sm text-on-surface-variant uppercase tracking-wider">{{ __('Stock Value') }}</span>
...
<span>{{ __('Current inventory valuation') }}</span>
</div>
</div>
</div>
...
<h3 class="font-title-lg text-on-surface">{{ __('Detailed Stock Levels') }}</h3>
<div class="flex gap-sm">
<select class="text-body-md border-outline-variant rounded-lg bg-surface focus:ring-primary border-none">
<option>{{ __('Filter by Category') }}</option>
<option>{{ __('Coffee') }}</option>
<option>{{ __('Dairy') }}</option>
<option>{{ __('Sweeteners') }}</option>
</select>
</div>
</div>
...
<tr>
<th class="p-lg font-label-sm text-on-surface-variant uppercase">{{ __('Item Name') }}</th>
<th class="p-lg font-label-sm text-on-surface-variant uppercase">Danh mục</th>
<th class="p-lg font-label-sm text-on-surface-variant uppercase">{{ __('SKU') }}</th>
<th class="p-lg font-label-sm text-on-surface-variant uppercase">{{ __('Stock') }}</th>
<th class="p-lg font-label-sm text-on-surface-variant uppercase">Trạng thái</th>
<th class="p-lg font-label-sm text-on-surface-variant uppercase">{{ __('Restocked') }}</th>
<th class="p-lg"></th>
</tr>
</thead>
...
<div>
<div class="font-title-lg text-body-lg">{{ __('Ethiopian Arabica') }}</div>
<div class="font-label-sm text-outline">Dark Roast (Whole)</div>
</div>
</div>
</td>
<td class="p-lg"><span class="font-body-md">{{ __('Coffee') }}</span></td>
<td class="p-lg"><span class="font-body-md text-outline">{{ __('COF-ARB-001') }}</span></td>
<td class="p-lg">
<div class="font-title-lg">45</div>
<div class="font-label-sm text-outline">kg</div>
</td>
<td class="p-lg">
<span class="px-sm py-1 bg-secondary-container/20 text-secondary rounded-full font-label-sm border border-secondary/10">{{ __('In Stock') }}</span>
</td>
<td class="p-lg"><span class="font-body-md">{{ __('Oct 24, 2023') }}</span></td>
<td class="p-lg">
...
<div>
<div class="font-title-lg text-body-lg">{{ __('Organic Oat Milk') }}</div>
<div class="font-label-sm text-outline">Barista Sửaion</div>
</div>
</div>
</td>
<td class="p-lg"><span class="font-body-md">{{ __('Dairy') }}</span></td>
<td class="p-lg"><span class="font-body-md text-outline">{{ __('DAI-OAT-042') }}</span></td>
<td class="p-lg">
<div class="font-title-lg text-tertiary">12</div>
<div class="font-label-sm text-outline">{{ __('Liters') }}</div>
</td>
<td class="p-lg">
<span class="px-sm py-1 bg-tertiary-container/20 text-tertiary rounded-full font-label-sm border border-tertiary/10">{{ __('Low Stock') }}</span>
</td>
<td class="p-lg"><span class="font-body-md">{{ __('Nov 02, 2023') }}</span></td>
<td class="p-lg">
<button class="p-2 hover:bg-surface-container-high rounded-full"><span class="material-symbols-outlined">more_vert</span></button>
</td>
</tr>
...
<div>
<div class="font-title-lg text-body-lg">{{ __('Agave Syrup') }}</div>
<div class="font-label-sm text-outline">{{ __('Organic Raw') }}</div>
</div>
</div>
</td>
<td class="p-lg"><span class="font-body-md">{{ __('Sweeteners') }}</span></td>
<td class="p-lg"><span class="font-body-md text-outline">{{ __('SWT-AGV-009') }}</span></td>
<td class="p-lg">
<div class="font-title-lg text-error">0</div>
<div class="font-label-sm text-outline">{{ __('Bags') }}</div>
</td>
<td class="p-lg">
<span class="px-sm py-1 bg-error-container/20 text-error rounded-full font-label-sm border border-error/10">{{ __('Out of Stock') }}</span>
</td>
<td class="p-lg"><span class="font-body-md">{{ __('Oct 15, 2023') }}</span></td>
<td class="p-lg">
<button class="p-2 hover:bg-surface-container-high rounded-full"><span class="material-symbols-outlined">more_vert</span></button>
</td>
</tr>
...
<div>
<div class="font-title-lg text-body-lg">{{ __('Compostable Cups 12oz') }}</div>
<div class="font-label-sm text-outline">{{ __('Eco-Series') }}</div>
</div>
</div>
</td>
<td class="p-lg"><span class="font-body-md">{{ __('Packaging') }}</span></td>
<td class="p-lg"><span class="font-body-md text-outline">{{ __('PKG-CUP-112') }}</span></td>
<td class="p-lg">
<div class="font-title-lg">450</div>
<div class="font-label-sm text-outline">{{ __('Units') }}</div>
</td>
<td class="p-lg">
<span class="px-sm py-1 bg-secondary-container/20 text-secondary rounded-full font-label-sm border border-secondary/10">{{ __('In Stock') }}</span>
</td>
<td class="p-lg"><span class="font-body-md">{{ __('Nov 10, 2023') }}</span></td>
<td class="p-lg">
<button class="p-2 hover:bg-surface-container-high rounded-full"><span class="material-symbols-outlined">more_vert</span></button>
</td>
</tr>
...
<span class="font-body-md text-on-surface-variant">{{ __('Showing 1-10 of 1,284 items') }}</span>
...
<button class="text-primary font-label-md hover:underline">{{ __('Manage All') }}</button>
</div>
...
<span class="font-body-lg font-semibold text-on-surface group-hover:text-primary transition-colors">{{ __('BeanBound Roasters') }}</span>
<span class="px-2 py-0.5 bg-secondary-container/30 text-secondary-fixed-dim text-[10px] font-bold uppercase rounded">{{ __('Lead: 3 Days') }}</span>
</div>
...
<div class="p-md rounded-xl border border-outline-variant hover:border-primary/30 transition-all group cursor-pointer">
<div class="flex justify-between items-start mb-xs">
<span class="font-body-lg font-semibold text-on-surface group-hover:text-primary transition-colors">{{ __('GreenDairy Distribution') }}</span>
<span class="px-2 py-0.5 bg-tertiary-container/30 text-tertiary text-[10px] font-bold uppercase rounded">{{ __('Lead: 1 Day') }}</span>
</div>
...
<div class="p-md rounded-xl border border-outline-variant hover:border-primary/30 transition-all group cursor-pointer">
<div class="flex justify-between items-start mb-xs">
<span class="font-body-lg font-semibold text-on-surface group-hover:text-primary transition-colors">{{ __('EcoPack Solutions') }}</span>
<span class="px-2 py-0.5 bg-secondary-container/30 text-secondary-fixed-dim text-[10px] font-bold uppercase rounded">{{ __('Lead: 5 Days') }}</span>
</div>
...
<h4 class="font-headline-md mb-xs">{{ __('Re-Stock Needed?') }}</h4>
<p class="font-body-md mb-lg opacity-90">{{ __('Auto-generate purchase orders based on your current low-stock alerts.') }}</p>
<button class="w-full py-md bg-white text-primary rounded-xl font-title-lg hover:bg-surface-container-lowest transition-all shadow-lg active:scale-[0.98]">{{ __('Generate Smart PO') }}</button>
</div>
</div>
</div>
</div>
