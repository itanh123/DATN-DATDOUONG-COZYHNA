                            ...
                            <tr class="hover:bg-surface-container-low/30 transition-colors group">
                                    ...
                                    <div class="flex items-center gap-md">
                                        ...
                                        <div>
                                            <div class="flex items-center gap-1">
                                                ...
                                                @if($voucher->is_hot)
                                                    <span class="px-1.5 py-0.5 bg-error text-white text-[10px] font-bold rounded flex items-center gap-1 leading-none shadow-sm"><span class="material-symbols-outlined text-[12px]">local_fire_department</span> HOT</span>
                                                @endif
                                            </div>
                                ...
                                <td class="px-lg py-lg">
                                    <div class="flex flex-col gap-1">
                                        <span class="text-body-md text-on-surface-variant font-bold">
                                        ...
                                        @if($voucher->discount_target == 'shipping')
                                            <span class="px-2 py-0.5 rounded text-[10px] font-bold bg-secondary-container text-on-secondary-container w-fit flex items-center gap-1">
                                                <span class="material-symbols-outlined text-[12px]">local_shipping</span> Vận chuyển
                                            </span>
                                        @elseif($voucher->discount_target == 'product')
                                            <span class="px-2 py-0.5 rounded text-[10px] font-bold bg-tertiary-container text-on-tertiary-container w-fit flex items-center gap-1">
                                                <span class="material-symbols-outlined text-[12px]">category</span> Sản phẩm
                                            </span>
                                        @else
                                            <span class="px-2 py-0.5 rounded text-[10px] font-bold bg-surface-variant text-on-surface-variant w-fit flex items-center gap-1">
                                                <span class="material-symbols-outlined text-[12px]">receipt_long</span> Toàn đơn
                                            </span>
                                        @endif
                                    </div>
                                </td>
