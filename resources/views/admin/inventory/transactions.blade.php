    ...
    <div class="max-w-[1400px] mx-auto space-y-gutter">
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            ...
            <div class="flex items-center gap-2">
                <a href="/admin/inventory" class="flex items-center gap-xs px-lg py-md border border-outline rounded-xl font-label-md text-on-surface-variant hover:bg-surface-container-low transition-all">
                ...
                <table class="w-full text-left">
                    ...
                    <tbody class="divide-y divide-outline-variant/30">
                        ...
                        <tr class="hover:bg-surface-container-low/50 transition-colors">
                            ...
                            <td class="p-lg">
                                <div class="font-title-lg {{ $transaction->transaction_type == 'EXPORT' ? 'text-error' : 'text-primary' }}">
                                    {{ $transaction->transaction_type == 'EXPORT' ? '-' : '+' }}{{ number_format($transaction->quantity, 2) }}
                                </div>
