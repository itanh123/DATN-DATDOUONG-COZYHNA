...
<head>
    ...
    .voucher-divider::before, .voucher-divider::after {
        ...
        width: 20px;
        height: 20px;
        background-color: #f8f9ff; /* Cùng màu nền body */
        border-radius: 50%;
        left: -11px;
        z-index: 10;
    ...
    /* Hiệu ứng thanh tiến độ (Progress bar animation) */
    .progress-bar-fill {
            ...
            <section class="mb-2xl">
                ...
                <div class="flex gap-md overflow-x-auto no-scrollbar pb-4 -mx-lg px-lg snap-x">
                    ...
                    <div class="voucher-card min-w-[320px] max-w-[350px] snap-center shrink-0">
                        <!-- Cột Trái -->
                        <div class="voucher-left w-[110px] flex flex-col justify-center items-center p-4 text-center shrink-0">
                            <span class="font-bold text-2xl leading-none mb-1">20%</span>
                            <span class="font-bold text-sm uppercase">GIẢM</span>
                        </div>
                        <!-- Đường Cắt -->
                        ...
                        <div class="p-4 flex-1 flex flex-col justify-between bg-white">
                            <div>
                                <h3 class="font-bold text-on-surface text-base mb-1 line-clamp-1">Giảm 20% Đồ Uống</h3>
                                <p class="text-xs text-on-surface-variant mb-2">Đơn tối thiểu 150k. HSD: 30/08</p>
                            </div>
                            <!-- Thanh tiến độ & Nút Lưu -->
                            <div class="flex items-center justify-between mt-2 gap-2">
                                <div class="flex-1">
                                    <div class="w-full bg-surface-container h-1.5 rounded-full overflow-hidden">
                                        <div class="bg-error h-full rounded-full progress-bar-fill" style="width: 80%;"></div>
                                    </div>
                                    <p class="text-[10px] text-error mt-1">Đã dùng 80%</p>
                                </div>
                                <button class="bg-primary hover:bg-primary/90 text-white text-xs font-bold py-1.5 px-3 rounded-full transition-transform active:scale-95 shadow-sm whitespace-nowrap animate-bounce">
                                    Lưu Ngay
                                </button>
                            </div>
                        </div>
                    ...
                    <!-- Voucher 2 -->
                    <div class="voucher-card min-w-[320px] max-w-[350px] snap-center shrink-0">
                        <div class="voucher-left w-[110px] flex flex-col justify-center items-center p-4 text-center shrink-0" style="background: linear-gradient(135deg, #eab308 0%, #ca8a04 100%);">
                            <span class="font-bold text-xl leading-none mb-1 text-white">FREE</span>
                            <span class="font-bold text-sm uppercase text-white">SHIP</span>
                        </div>
                        <div class="voucher-divider w-[2px]"></div>
                        <div class="p-4 flex-1 flex flex-col justify-between bg-white">
                            <div>
                                <h3 class="font-bold text-on-surface text-base mb-1 line-clamp-1">Miễn Phí Vận Chuyển</h3>
                                <p class="text-xs text-on-surface-variant mb-2">Giảm tối đa 30k. Áp dụng mọi đơn.</p>
                            </div>
                            <div class="flex items-center justify-between mt-2 gap-2">
                                <div class="flex-1">
                                    <div class="w-full bg-surface-container h-1.5 rounded-full overflow-hidden">
                                        <div class="bg-primary h-full rounded-full progress-bar-fill" style="width: 45%;"></div>
                                    </div>
                                    <p class="text-[10px] text-primary mt-1">Sắp hết</p>
                                </div>
                                <button class="bg-primary hover:bg-primary/90 text-white text-xs font-bold py-1.5 px-3 rounded-full transition-transform active:scale-95 shadow-sm whitespace-nowrap">
                                    Lưu Ngay
                                </button>
                            </div>
                        </div>
                    ...
                    <!-- Voucher 3 -->
                    <div class="voucher-card min-w-[320px] max-w-[350px] snap-center shrink-0">
                        <div class="voucher-left w-[110px] flex flex-col justify-center items-center p-4 text-center shrink-0" style="background: linear-gradient(135deg, #ef4444 0%, #b91c1c 100%);">
                            <span class="font-bold text-2xl leading-none mb-1 text-white">50K</span>
                            <span class="font-bold text-sm uppercase text-white">GIẢM</span>
                        </div>
                        <div class="voucher-divider w-[2px]"></div>
                        <div class="p-4 flex-1 flex flex-col justify-between bg-white">
                            <div>
                                <h3 class="font-bold text-on-surface text-base mb-1 line-clamp-1">Khách Mới Giảm 50K</h3>
                                <p class="text-xs text-on-surface-variant mb-2">Dành cho đơn hàng đầu tiên.</p>
                            </div>
                            <div class="flex items-center justify-between mt-2 gap-2">
                                <div class="flex-1">
                                    <div class="w-full bg-surface-container h-1.5 rounded-full overflow-hidden">
                                        <div class="bg-error h-full rounded-full progress-bar-fill" style="width: 95%;"></div>
                                    </div>
                                    <p class="text-[10px] text-error mt-1 font-bold">Chỉ còn 5 mã!</p>
                                </div>
                                <button class="bg-primary hover:bg-primary/90 text-white text-xs font-bold py-1.5 px-3 rounded-full transition-transform active:scale-95 shadow-sm whitespace-nowrap">
                                    Lưu Ngay
                                </button>
