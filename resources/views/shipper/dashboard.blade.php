...
<h2 class="font-headline-md text-headline-md font-black text-primary dark:text-primary-fixed-dim">{{ __('Fleet Logistics') }}</h2>
...
<span class="font-label-md">{{ __('San Francisco Hub B') }}</span>
</div>
</div>
<div class="flex items-center gap-lg">
<div class="relative hidden lg:block">
<input class="bg-surface-container-low border-none rounded-full px-xl py-2 text-sm w-64 focus:ring-2 focus:ring-primary/20" placeholder="{{ __('Search orders...') }}" type="text"/>
<span class="material-symbols-outlined absolute right-3 top-2 text-on-surface-variant">search</span>
</div>
<div class="flex items-center gap-md">
<button class="material-symbols-outlined p-2 hover:bg-surface-container-high rounded-full transition-colors relative">{{ __('notifications') }}<span class="absolute top-2 right-2 w-2 h-2 bg-error rounded-full border-2 border-surface"></span>
</button>
<button class="material-symbols-outlined p-2 hover:bg-surface-container-high rounded-full transition-colors text-error">emergency_home</button>
</div>
</div>
</header>
...
<div>
<p class="font-label-sm text-on-surface-variant">{{ __('Rating') }}</p>
...
<div>
<p class="font-label-sm text-on-surface-variant">{{ __('Est. Earnings') }}</p>
...
<button class="px-md py-xs bg-surface-container rounded-lg font-label-md hover:bg-surface-container-high transition-colors">{{ __('Re-center') }}</button>
...
<span class="material-symbols-outlined text-[18px]">navigation</span>{{ __('Navigate') }}</button>
</div>
</div>
...
<div>
<p class="font-label-sm text-xs text-on-surface-variant">{{ __('CURRENT POSITION') }}</p>
<p class="font-body-md font-bold">{{ __('Transit to Stop 4/8') }}</p>
</div>
</div>
...
<span class="material-symbols-outlined text-primary">view_list</span>{{ __('Upcoming Delivery Queue') }}</h3>
...
<div>
<p class="font-title-lg text-sm">{{ __('Organic Wellness Spa') }}</p>
...
<p class="font-label-sm text-[10px] uppercase text-on-surface-variant">{{ __('Items') }}</p>
<p class="font-body-md text-sm">24x Phúteral Water, 12x Kombucha</p>
</div>
<div class="text-right min-w-[100px]">
<p class="font-label-sm text-[10px] uppercase text-on-surface-variant">{{ __('ETA') }}</p>
...
<div>
<p class="font-title-lg text-sm">{{ __('The Daily Grind Cafe') }}</p>
...
<div>
<p class="font-title-lg text-sm">{{ __('TechTower Lobby Bar') }}</p>
...
<h4 class="font-label-md text-white/70 uppercase tracking-widest mb-md">{{ __('Shift Control') }}</h4>
<div class="flex items-center justify-between mb-lg">
<div>
<p class="font-display-lg text-display-lg leading-tight" id="shift-timer">06:12:45</p>
<p class="font-label-sm text-white/80">{{ __('Time on Road') }}</p>
</div>
...
<span class="material-symbols-outlined">stop_circle</span>{{ __('End Shift') }}</button>
<p class="text-center mt-md text-xs text-white/60">{{ __('Shift started at 08:30 AM • Hub SF-B') }}</p>
</div>
</section>
<!-- Performance Snapshot -->
<section class="glass-card rounded-2xl p-lg border border-outline-variant/50">
<div class="flex justify-between items-center mb-lg">
<h4 class="font-title-lg text-sm">{{ __('Weekly Performance') }}</h4>
...
<span class="text-[10px] text-on-surface-variant">{{ __('Mon') }}</span>
<span class="text-[10px] text-on-surface-variant">{{ __('Tue') }}</span>
<span class="text-[10px] text-on-surface-variant">{{ __('Wed') }}</span>
<span class="text-[10px] text-on-surface-variant">{{ __('Thu') }}</span>
<span class="text-[10px] text-on-surface-variant">{{ __('Fri') }}</span>
<span class="text-[10px] font-bold text-primary">{{ __('Sat') }}</span>
<span class="text-[10px] text-on-surface-variant">{{ __('Sun') }}</span>
</div>
</section>
<!-- Safety & Vehicle Checklist -->
<section class="glass-card rounded-2xl p-lg border border-outline-variant/50">
<h4 class="font-title-lg text-sm mb-lg">{{ __('Vehicle Integrity') }}</h4>
...
<span class="font-body-md text-sm">{{ __('Tire Pressure') }}</span>
</div>
<span class="font-label-sm text-primary">{{ __('Optimal') }}</span>
</div>
<div class="flex items-center justify-between p-sm bg-surface rounded-lg">
<div class="flex items-center gap-md">
<span class="material-symbols-outlined text-primary" style="font-variation-settings: 'FILL' 1;">battery_charging_full</span>
<span class="font-body-md text-sm">{{ __('Battery Health') }}</span>
</div>
...
<span class="font-body-md text-sm">{{ __('Brake Pads') }}</span>
</div>
<span class="font-label-sm text-tertiary">{{ __('Service Soon') }}</span>
</div>
</div>
<button class="w-full mt-lg border-2 border-outline-variant text-on-surface-variant font-label-md py-md rounded-xl hover:bg-surface-container transition-colors">{{ __('Full Safety Report') }}</button>
</section>
</div>
</div>
</div>
